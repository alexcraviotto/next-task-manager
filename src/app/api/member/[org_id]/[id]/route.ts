...
export async function PATCH(
  ...
  try {
    ...
    await Promise.all(
      taskRatings.map(async (task) => {
        // Solo procesar si tanto clientSatisfaction como clientWeight no son null
        if (task.clientSatisfaction !== null && task.clientWeight !== null) {
