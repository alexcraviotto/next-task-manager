/*
  ...
  - You are about to drop the column `limite_esfuerzo` on the `Organization` table. All the data in the column will be lost.
...
CREATE TABLE "new_Organization" (
    ...
    "effort_limit" INTEGER NOT NULL DEFAULT 0,
